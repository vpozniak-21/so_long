...
/*Replace Internal MiniLibX Functions If you are using
functions like mlx_loop_end or mlx_destroy_display
(which are defined in mlx_int.h),
	you need to replace them with alternatives from the public API of MiniLibX
		.For example :
	Use mlx_destroy_window to destroy the window.Use a custom
	flag to break out of the event loop instead of mlx_loop_end.
